<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ELibrary2._Default" %>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroow">
                            ...
                            <div class="form-group row">
                                ...
                                <asp:TextBox id="txtEmailRegistartion"  type="text" class="form-control col-md-8" runat="server"></asp:TextBox>
                            </div>

                            <div class="form-group row">
                                <label class="text-black col-md-3 control-label" for="txtUserName">Потребителско име:*</label><br />
                                <asp:TextBox id="txtUserNameRegistartion"  type="text" class="form-control col-md-8" runat="server"></asp:TextBox>

                            </div>

                            <div class="form-group row">
                                <label class="text-black col-md-3 control-label" for="txtPassword">Парола:*</label><br />
                                <asp:TextBox id="txtPasswordRegistartion"  type="password" class="form-control col-md-8" runat="server"></asp:TextBox>

                            </div>
                       
                            <div class="form-group row">
                                <label class="text-black col-md-3 control-label" for="txtPassword">Повтори парола:*</label><br />
                                <asp:TextBox id="txtConfirmPasswordRegistartion"  type="password" class="form-control col-md-8" runat="server"></asp:TextBox>
                            </div>   
                        ...
                        <div class="modal-footer container">
                          <asp:Button ID="btnSingUpPerson" runat="server" Text="Регистирай" class="btn btn-primary btn-block col-md-3" OnClick="btnSingUpPerson_Click"/>
                        </div>
                    </div>                    
                </div>
              </ContentTemplate>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroow">
                            ...
                            <div class="form-group row">
                                <label class="text-black col-md-3 control-label " for="email">Email:</label>
                                <asp:TextBox id="txtEmailLogIn"  type="email" class="form-control col-md-8" runat="server"></asp:TextBox>
                            </div>   

                            <div class="form-group row">
                                <label class="text-black col-md-3 control-label" for="txtPassword">Парола:</label><br />
                                <asp:TextBox id="txtPasswordLogIn"  type="password" class="form-control col-md-8" runat="server"></asp:TextBox>
                            </div> 
                        </div>
